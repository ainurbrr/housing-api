...
2. Clone repository ini menggunakan perintah `git clone https://github.com`
3. Change direktory menggunakan perintah `cd housing-management`
...
10. Masukkan perintah `php artisan storage:link` untuk lebih mudah mengakses file storage
11. Masukkan perintah `php artisan serve` untuk menjalankan server local pada project laravel


[API Docs](https://documenter.getpostman.com/view/20733750/2sA3s9C7uT)
